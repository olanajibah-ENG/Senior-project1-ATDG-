...
const Dashboard: React.FC = () => {
    ...
    const handleCodeSubmit = async (payload: {
        ...
        try {
            ...
            if (payload.zipFile) {
                console.log('📦 ZIP detected — using folder-upload flow');
                ...
                console.log('✅ Folder uploaded:', uploadResult);
                ...
                console.log('📌 Using project_id for analysis:', actualProjectId);

                // Step 2: بدء تحليل المشروع
                const analyzeResult = await UnifiedApiService.analyzeProject(actualProjectId);
                console.log('✅ Project analysis started:', analyzeResult);
                ...
                for (let attempt = 1; attempt <= maxAttempts; attempt++) {
                    console.log(`🔄 Polling project analysis status (${attempt}/${maxAttempts})...`);
                    ...
                    try {
                        ...
                        if (statusData.status === 'COMPLETED' || statusData.status === 'COMPLETED_WITH_ERRORS') {
                            ...
                            throw new Error('Project analysis failed on server');
                        }
                        // IN_PROGRESS → keep polling
                    } catch (pollError: any) {
                        // ممكن يرجع 404 لما التحليل لسا ما بدأ
                ...
                console.log('✅ Project class diagram fetched:', diagramData);
            ...
            if (payload.githubUrl) {
                console.log('🐙 GitHub URL detected — using folder-upload flow');
            ...
            console.log('✅ Local files — using codefiles flow');
            ...
            console.log('✅ Files uploaded successfully, navigating...');
