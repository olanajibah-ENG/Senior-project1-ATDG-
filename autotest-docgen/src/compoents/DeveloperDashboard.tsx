...
import {
  ...
  TrendingUp, Activity, Clock, Zap, BookOpen, Send, GitCompare
} from 'lucide-react';
...
import type { ConflictType } from './ConflictDetection';
...
const DeveloperDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'analyses' | 'explanations' | 'evaluations' | 'conflict'>('analyses');
  ...
  const handleConflictSelect = (type: ConflictType) => {
  ...
  return (
    <div className="developer-dashboard">
      ...
      <div className="dashboard-tabs">
        ...
        <button
          type="button"
          className="tab-btn conflict-tab"
          onClick={() => {
      ...
      <div className="dashboard-content">
        ...
        {activeTab === 'explanations' && (
          <div className="explanations-section">
            <div className="section-header">
              ...
              <button type="button" className="new-explanation-btn" onClick={() => setActiveTab('explanations')}>
                <Zap />
            ...
            <div className="new-explanation-form">
              ...
              <button type="button" onClick={handleRequestExplanation} className="request-btn">
                <Send />
                Request Explanation
              </button>
            </div>
        ...
        {activeTab === 'conflict' && (
          <div className="conflict-detection-section">
            <div className="section-header">
              <h2>Conflict Detection Analysis</h2>
              <p style={{ color: 'rgba(255,255,255,0.8)', marginTop: '0.5rem' }}>
                Compare your code with documentation, detect conflicts between versions, or perform full analysis
              </p>
            </div>
      ...
      <ConflictTypeSelector
        isOpen={showConflictSelector && activeTab === 'conflict'}
        onClose={() => setShowConflictSelector(false)}
