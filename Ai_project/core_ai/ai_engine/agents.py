...
class HighLevelAgent(BaseAgent):
    def process(self, code_content, class_name=None, analysis_summary=None, file_name=None, **kwargs):
        system = (
            "Analyze the following Python file and generate a HIGH-LEVEL technical document.\n"
            ...
            "- [bullet: key responsibility 1]\n"
            "- [bullet: key responsibility 2]\n"
            "- [bullet: key responsibility 3]\n\n"
            "## Key Capabilities\n"
            "- [capability 1]\n"
            "- [capability 2]\n"
            "- [capability 3]\n\n"
            "---\n"
            "[For EACH class repeat this block:]\n\n"
            "## Class: [ClassName]\n"
            "PURPOSE:\n"
            ...
            "1. [step 1]\n"
            "2. [step 2]\n\n"
            "### Method: method_name(self, param: type)  [if exists]\n"
            "LOGIC FLOW:\n"
            "1. [step 1]\n"
            "2. [step 2]\n\n"
            "---\n"
            ...
            "[filename]\n"
            "[Source Code will be provided below]\n\n"
            "IMPORTANT:\n"
        ...
        context = ""
        if class_name: context += f"Class Name: {class_name}\n"
        if analysis_summary: context += f"Analysis Summary:\n{analysis_summary}\n"

        file_label = f"File: {file_name}\n" if file_name else ""
        user = f"{file_label}{context}\nSource Code:\n{code_content}\n\nProvide the report following the structure above. Use '{file_name}' as the filename in the Source Code Analysis section."
