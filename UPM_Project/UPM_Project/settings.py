...
# ── Password Hashers (سرّع الـ signup في بيئة التطوير) ─────────────────────
# Django 5.x افتراضي: PBKDF2 870,000 iteration = بطيء جداً للاختبار
# هنا نخفضها لـ 10,000 في بيئة التطوير فقط
if DEBUG:
    PASSWORD_HASHERS = [
